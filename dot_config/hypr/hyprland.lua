...
hl.config({
	general = {
		...
		col = {
			active_border = { colors = { colors.sky, colors.sapphire }, angle = 45 },
...
-- Super+Tab to toggle between focused window
hl.bind(mainMod .. " + tab", hl.dsp.focus({ last = true }))
-- Super+Shift+Tab to cycle up through workspaces
hl.bind(secondMod .. " + tab", hl.dsp.focus({ workspace = "e+1" }))

-- VIM-style focus keys
